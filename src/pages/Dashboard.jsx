                ...
                {pcc1.map((item) => (
                  <div className="">
                    <div className="flex md:gap-10 gap-8 max-[620px]:gap-6 rounded-md p-2 text-center items-center max-[360px]:gap-1 ">
                      <h2 className={`bg-[${item.color}] border md:w-64 w-56 font-medium py-2 rounded-full 2xl:py-4`}>
                        {item.title}
                      </h2>
                      <p className={`bg-white px-4 py-1 border border-[${item.color}] rounded-full min-[2000px]:px-6 2xl:py-2 max-[450px]:px-2`}>
                        100.00
                      </p>
                      <p className={`bg-white px-4 py-1 border border-[${item.color}] rounded-full min-[2000px]:px-6 2xl:py-2 max-[450px]:px-2`}>
                        100.00
