...
const EnergyUnits = ({energy,monthlyEnergy,kvah2,kvah1}) => {
  return (
      <div className="bg-white rounded-lg shadow  text-lg font-OpenSans dark:bg-[#2c2c2c] dark:text-white text-center p-5 w-full h-full">
        ...
        <p className="bg-[#a4a4e3] mx-4 p-2 my-3 rounded-lg font-semibold">{(kvah2 - kvah1)} Units</p>
        <p className="font-medium mt-6" >Units Consumed This Month</p>
        <p className="bg-[#a4a4e3] mx-4 my-3 p-2 rounded-lg font-semibold">{monthlyEnergy} Units</p>
      </div>
  );
};
